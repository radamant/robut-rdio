RdioPlayer = (function () {
  ...
  function establishControls(rdio) {
      ...
      rdio.toggle = function () { 
          if ( $(rdio.player).attr("playingState") == "playing" ) {
              rdio.pause();
          } else {
              rdio.play();
          }
...
function playerKeyboardShortcuts() {
  ...
  $(document).keypress(function(evt) {
    ...
    switch (evt.charCode) {
      ...
      case 32: window.rdio.toggle(); break;
      
      // Left - restart track
      case 80: case 112: window.rdio.player.rdio_previous(); break;
      
      // Right - skip track
      case 78: case 110: window.rdio.player.rdio_next(); break;
    }
